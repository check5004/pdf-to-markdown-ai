...
import { SparklesIcon, BugAntIcon } from './Icons';
...
const ResultsPanel: React.FC<ResultsPanelProps> = ({ stateManager }) => {
  const {
    isLoading, isGeneratingQuestions, isRefining, isGeneratingDiff,
    progressMessage,
    error,
    analysisHistory,
    questionsMap, answeredQuestionsMap, customInstructionsMap, diffMap,
    latestRefiningSourceId, latestDiffingSourceId,
    exchangeRateInfo,
    handleCopy, handleDownload,
    handleGenerateQuestions, handleRefineDocument, handleGenerateDiff,
    isAnyLoading,
  } = stateManager;
